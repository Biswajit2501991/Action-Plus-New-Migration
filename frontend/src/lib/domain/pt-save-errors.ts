/** Map PT profile PATCH failures to actionable staff-facing messages. */
export function ptSaveErrorMessage(err: unknown, fallback = "Could not save PT client changes. Try again or contact owner."): string {
