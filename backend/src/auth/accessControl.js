...
export function normalizeAccess(access) {
  return {
    ...
    settings: {
      viewAppearance: access?.settings?.viewAppearance !== false,
      manageGymBranches: access?.settings?.manageGymBranches === true,
      manageFineRule: access?.settings?.manageFineRule !== false,
      manageSystemFeatures: access?.settings?.manageSystemFeatures === true,
      ...
      manageExerciseTypes: access?.settings?.manageExerciseTypes !== false,
